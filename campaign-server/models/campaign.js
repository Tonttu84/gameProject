      ...
      new mongoose.Schema(
        {
          ...
          // The once-per-turn reinforcement ledger (docs/CAMPAIGN_PLAN.md
          // "SLICE 3 — reinforcement", decision I): the day this charter last
          // took replacements. A day STAMP, mirroring recruit.drawnDay's
          // sealed-day convention rather than a parallel array like
          // raid.squadAssignment — it rides on the squad it describes, so it
          // survives a wipe with the charter and needs no end-of-day clearing.
          // Undefined on a charter that has never reinforced (day counts from
          // 1, so no stamp can collide with it).
          reinforcedDay: { type: Number },
