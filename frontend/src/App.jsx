    ...
    return (
      <div className="app">
        ...
        <ForgePanel
          ...
          onConstruct={guarded(buildConstruction)}
          locked={phaseRank(serverPhase) > phaseRank('prepare')}
        />
      </div>
    )
