...
// Rides at the Horse's pace (movementSpeed 28, same as heavy Cavalry until
// barding charges heavies a movement cost) and javelin-trained (ballistic
// skill 8), at the cost of the Soldier rider's heavy armour and shield. The campaign layer derives foraging/scouting value from
